...
public class JwtUserAuthTokenFilter extends OncePerRequestFilter {
    @Autowired
    private JwtUserProvider tokenProvider;

    @Autowired
    private UserDetailsServiceImpl userDetailsService;

    private static final Logger logger = LoggerFactory.getLogger(JwtUserAuthTokenFilter.class);
